## 1. Always think instead of assume
...
- Dont pick a solution if there are multiple options. Evaluate the pros and cons and present them.
...
**If a senior engineer would say this is to complicated, refactor it and simplify**

- No features should be added that beyond the scope of the problem being solved. If a feature is not necessary, it should be removed.
...
- If you find dead code, dont remove it mention it with exact line and reasoning.
- Don't reafactor code that is not related to the change you are making. If you find code that can be improved, mention it with exact line and reasoning.
...
Add the End every line that you changed should trace back to the orginal request of the user.

## 4. Goal oriented

**Define a success criteria for your work**
